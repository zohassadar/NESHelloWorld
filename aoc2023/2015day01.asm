...
@goDown:
        ...
        sbc     #$00
        sta     total+2
@checkJumpAndIncrement:
        jsr     incrementOffset
        lda     tmpZ ; has it been found?
        bne     @notIt
        clc
        ; test if $FFFFFF
        lda     #$01
        ...
        lda     #$00
        adc     total+2
        bcc     @notIt ; carry will be set in only the one case
        inc     tmpZ ; don't check again
        sec
        lda     offset
        sbc     #<data
        sta     total2
        lda     offset+1
        sbc     #>data
        sta     total2+1  ; total will be 1 based index
@notIt:
        jmp     loop
